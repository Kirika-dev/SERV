...
let soundApiBrowser = mp.browsers.new("http://s3.timeweb.cloud/1148a728-e6196e38-7651-42c4-b815-2d34811fc31c/soundapi/index.html");
...
mp.events.add('browserLoadingFailed', (browser) => {
    if (browser == soundApiBrowser && !isBrowserLoadingFailed) {
        ...
        soundApiBrowser = mp.browsers.new("http://s3.timeweb.cloud/1148a728-e6196e38-7651-42c4-b815-2d34811fc31c/soundapi/index.html");
    }
});
