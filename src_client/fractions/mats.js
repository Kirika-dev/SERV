...
gm.events.add('matsL', (act) => { //load
	...
	try 
	{
		...
		switch (act) {
			case 1:
				global.input.set(translateText("Загрузить маты"), translateText("Введите кол-во матов"), 6, "loadmats");
				break;
			case 2:
				global.input.set(translateText("Загрузить маты"), translateText("Введите кол-во матов"), 6, "loadmats");
				break;
...
gm.events.add('matsU', (act) => { //unload
	...
	try 
	{
		...
		switch (act) {
			case 1:
				global.input.set(translateText("Выгрузить маты"), translateText("Введите кол-во матов"), 6, "unloadmats");
				break;
			case 2:
				global.input.set(translateText("Выгрузить маты"), translateText("Введите кол-во матов"), 6, "unloadmats");
				break;
